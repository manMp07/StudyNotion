                    ...
                    <TitleWrapper className="text-center">
                        <PolicyWrapper className="privacy">
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    Welcome to Study Notion. We are committed to
                                    protecting your personal information and
                                    your right to privacy. If you have any
                                    questions or concerns about our policy or
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    ...
                                    provide to us, such as name, email address,
                                    contact information, and payment
                                    information. We collect personal information
                                    when you register for our services, create
                                    or consume educational content, rate
                                    content, participate in activities on the
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    ...
                                    our platform for a variety of business
                                    purposes described below. We process your
                                    personal information for these purposes in
                                    reliance on our legitimate business
                                    interests, in order to enter into or perform
                                    a contract with you, with your consent,
                                    and/or for compliance with our legal
                                    obligations.
                                </Paragraph>
                            </Section>
                            <Section className="text-left">
