                    ...
                    <TitleWrapper className="text-center">
                        <PolicyWrapper className="terms">
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    Welcome to Study Notion. These terms and
                                    conditions outline the rules and regulations
                                    for the use of Study Notion's Website,
                                    located at www.studynotion.com.
                                </Paragraph>
                            </Section>
                            <Section className="text-left">
                                <Heading2>
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    Unless otherwise stated, Study Notion and/or
                                    its licensors own the intellectual property
                                    rights for all material on Study Notion. All
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    By using Study Notion, you agree to abide by
                                ...
                                <SubSection>
                                    ...
                                    <Paragraph>
                                        ...
                                        platform, you may be required to create
                                        an account. You agree to provide
                                ...
                                <SubSection>
                                    ...
                                    <Paragraph>
                                        You agree not to engage in any activity
                                        that may interfere with or disrupt the
                                        operation of the platform or the servers
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    You retain ownership of any intellectual
                                    property rights that you hold in the content
                                    you submit to the platform. By submitting,
                                    posting, or displaying content on or through
                                    the platform, you grant Study Notion a
                                    worldwide, non-exclusive, royalty-free
                                    license to use, copy, reproduce, process,
                                    adapt, modify, publish, transmit, display,
                                    and distribute such content in any and all
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    You agree to indemnify and hold Study Notion
                                    and its affiliates, directors, officers,
                                    employees, and agents harmless from and
                                    against any liabilities, losses, damages, or
                                    costs, including reasonable attorneys' fees,
                                    incurred in connection with or arising from
                                    any third-party allegations, claims,
                                    actions, disputes, or demands asserted
                                    against any of them as a result of or
                                    relating to your content, your use of the
                                    platform, or any willful misconduct on your
                                    part.
                                </Paragraph>
                            </Section>
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    Study Notion reserves the right to modify or
                                    discontinue, temporarily or permanently, the
                                    platform or any part of it with or without
                                    notice. You agree that Study Notion shall
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    Study Notion may terminate or suspend access
                                    to the platform immediately, without prior
                            ...
                            <Section className="text-left">
                                ...
                                <Paragraph>
                                    ...
                                    Country], without regard to its conflict of
                                    law provisions. Our failure to enforce any
                                    right or provision of these terms will not
                                    be considered a waiver of those rights. If
                                    any provision of these terms is held to be
